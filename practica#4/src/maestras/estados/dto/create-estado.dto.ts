...
/**
 * DTO para la creación de un Estado
 * Contiene las validaciones necesarias para crear un nuevo estado en el sistema
 */
export class CreateEstadoDto {
   ...
   * @example 'Estado que indica que el registro está activo y disponible'
   */
  @IsOptional()
